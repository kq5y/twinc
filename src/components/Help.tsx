  ...
  return (
    <div className={helpStyle}>
      ...
      <div className="instruction">
        ...
        <p>
          カレンダーを追加→新しいカレンダー
          を作成を選択して、カレンダーに名前をつけて、カレンダーを作成してく
        ...
        />
        <p>
          他の予定が入っているカレンダーに追加してしまうと、後で削除したいときに削除するのが面倒になってしまうので、注意してください
        </p>
        <p>
          これで完成です!
        ...
        <div className="notice">
          ...
          <p>祝日や学年暦に書かれている休日は、授業予定が登録されません</p>
          <p>今年度開講されない授業については、登録することができません</p>
          <p>通年授業の登録には対応していません</p>
          <p>学年暦に書かれている振替に対応して、授業予定は登録されています</p>
          <p>
